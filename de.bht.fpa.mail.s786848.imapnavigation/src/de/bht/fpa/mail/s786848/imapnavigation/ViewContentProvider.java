...
public class ViewContentProvider implements ITreeContentProvider {
  ...
  public Object[] getChildren(Object parentElement) {
    ...
    if (parentElement instanceof ImapElement) {
      ImapElement e = (ImapElement) parentElement;
      return e.getChildren().toArray(new ImapElement[0]);
    }
  ...
  public boolean hasChildren(Object element) {
    ...
    // children.
    return ((ImapElement) element).hasChildren();
  }
